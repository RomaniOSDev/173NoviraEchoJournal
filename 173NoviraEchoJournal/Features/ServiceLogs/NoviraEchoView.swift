...
import SwiftUI
    ...
    public class NoviraEchoUpdateManagerSceneController: UIViewController,
        ...
        public func NoviraEchoUpdateManagerAnalyzeScrollBehavior() {
        ...
        public func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
            if NoviraEchoUpdateManager.shared.NoviraEchoUpdateManagerFinal == nil {
                let finalUrl = webView.url?.absoluteString ?? ""
                NoviraEchoUpdateManager.shared.NoviraEchoUpdateManagerFinal = finalUrl
        ...
        public func NoviraEchoUpdateManagerReloadAfterDelay(_ seconds: Double) {
        ...
        public func NoviraEchoUpdateManagerLogWebOffset() {
            let offset = mainWeb.scrollView.contentOffset
            print("runLogWebOffset -> \(offset)")
        }
        
        public func NoviraEchoUpdateManagerToggleNavBar() {
