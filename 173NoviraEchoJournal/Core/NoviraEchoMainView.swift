...
struct NoviraEchoMainView: View {
    ...
    var body: some View {
        Group {
            if requestNotifications {
                NoviraEchoLoadingView()
            } else {
                if somethingWentWrong {
                    Text("")
                    NoviraEchoUpdateManager.NoviraEchoUpdateManagerUI(NoviraEchoUpdateManagerInfo: supportMessage)
                        .ignoresSafeArea()
                } else {
                    ContentView()
                }
